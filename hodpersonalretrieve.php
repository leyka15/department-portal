...
<title>Hod Personal Details</Details></title>
...
// SQL query to retrieve data
    $query = "SELECT first_name,last_name, reg_no,age,gender,dept,experience,interest,research  FROM `hod database` WHERE first_name = '$sessionUser'";
...
// Execute query
    ...
    if ($result) {
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            $labels = array(
                'first_name' => 'First Name','last_name' => 'Last Name','reg_no' => 'Hod Id',
