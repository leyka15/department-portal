...
<html lang="en">
  ...
  <meta charset="UTF-8">
    ...
    <title>Hod personal Database</title>
    <link rel="stylesheet" href="facultypersonal.css">
  </head>
  <body>
    <div class="signup-box">
      <h1>Hod personal Database</h1>
      <form action="" method="POST">
        ...
        <input type="button" name="view" value="View" onclick="window.location.href='hodpersonalretrieve.php'">
        <input type="button" name="view" value="Edit" onclick="window.location.href='hodpersonaledit.php'">
      </form>
    </div>
    <div class="sidebar"> 
        <div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Database connection
    $conn = mysqli_connect('localhost', 'root', 'root', 'hod');
    ...
    $sql = "INSERT INTO `hod database` (`first_name`,`last_name`, `reg_no`, `age`, `gender`, `dept`, `experience`, `interest`, `research`) 
