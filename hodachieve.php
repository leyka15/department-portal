  ...
  <body>
    <div class="container">
      ...
      <form action="" method="POST">
        ...
        <input type="button" name="view" value="View" onclick="window.location.href='hodachieveretrieve.php'">
      </form>
    </div>
    <div class="sidebar"> 
        <div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `hodachievements` (`first_name`,`last_name`, `reg_no`,`dept`, `journalpaper`, `conferencepaper`, `awards`,`coursesandcertification`) 
