  ...
  <body>
    <div class="signup-box">
      ...
      <form action="" method="POST">
        ...
        <label>course from date</label>
        <input type="text" name="coursefromdate" >
        <label>course to date</label>
        <input type="text" name="coursetodate" >
        </br>
        <button type="submit" class="btn">Submit</button>
        <input type="button" name="class" value="view" onclick="window.location.href='facachieveretrieve.php'">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `facultyrangeachievements` (`first_name`,`last_name`, `reg_no`,`dept`, `journalpaper`, `conferencepaper`, `awards`,`coursesandcertification`,`coursefromdate`,`coursetodate`) 
            VALUES ('$fname','$sname', '$id','$dept', '$journal', '$conference', '$AwardsReceived','$CoursesandCertification','$coursefromdate','$coursetodate')";
