...
<div class = "login">
        ...
        <p style="text-align: center; padding-top: 20px; font-size: 15px;">Don't have account?<a href="facultysignup.php">Signup Here!</a></p>
</div>
<div class="sidebar"> 
        <div>
            <ul>
...
if(isset($_POST["submit"])) {    
    if(!empty($_POST['user']) && !empty($_POST['pass'])) {  
        ...
        // Execute query
        $query = mysqli_query($_con, "SELECT * FROM faculty WHERE user='".$user."' AND password='".$pass."'");  
        ...
        if($query) {
            ...
            if($numrows != 0) {  
                ...
                if($user == $dbusername && $pass == $dbpassword) {  
                    ...
                    /* Redirect browser */  
                    header("Location: facultywelcome.php");
